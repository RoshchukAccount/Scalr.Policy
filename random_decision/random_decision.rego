...
deny[reason] {
    ...
    reason := sprintf(
        "Unlucky you: got %d, but 5 or more is required, Unlucky you: got %d, but 5 or more is required, Unlucky you: got %d, but 5 or more is required, Unlucky you: got %d, but 5 or more is required",
        [number]
    )
}
